...
function updateSidebarWithMarkerData(processedData) {
    ...
    sidebar.innerHTML = ''; // Clear existing content before updating
    // Loop through processed data and update the sidebar accordingly
    // This is a placeholder; actual implementation should dynamically create and insert HTML based on processedData
}
