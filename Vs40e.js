...
function updateSidebar() {
    ...
    markers.forEach(marker => {
        if (marker.getMap() !== null) {
            ...
            infoDiv.innerHTML = marker.infowindowContent; // Ensure this variable is correctly populated earlier in the code
            sidebar.appendChild(infoDiv);
        }
    });
}

// Correctly closing updateSidebar and continuing with the rest of the script
